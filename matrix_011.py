...
# - pourquoi la ligne 1.2 produit un set, mais 1.1 produit une liste ?
...
print 'Diff entre [x*y for x,y in ll] et ' \
      '           [x*y for x in lx for y in ly] est = ',
...
dict_carrees ={x:x*x for x  in range(10)}
